...
SRC_MAP   = mapper/mapper.c mapper/axrom.c mapper/cnrom.c mapper/mmc1.c mapper/uxrom.c
...
$(eval $(call mktest, apu/9-reset_timing, --max_cycles 0xb5585))
$(eval $(call mktest, apu/10-len_halt_timing, --max_cycles 0xd9b28))
$(eval $(call mktest, apu/11-len_reload_timing, --max_cycles 0xd9b2c))
$(eval $(call mktest, apu/12-irq_timing, --max_cycles 0xe0f7d))
